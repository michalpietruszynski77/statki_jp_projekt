...
void gra::start(){
    cout<<"Wybierz numer"<<endl<<"1 -Start"<<endl<<"2 -Instrukcja"<<endl;
    int num;
    int e=0;
    string p;
    while(e==0){
        ...
        switch(num){
            case 1:
                ...
                break;
            case 2:
                cout<<"Program to gra w statki PvP. Na początku gry każdy z graczy ustawia po kolei swoje statki, najpierw wpisując współrzędne początku statku, a następnie wybierając z opcji wyświetlonych na"<<endl<<"terminalu współrzędne końca statku. Po ustawieniu wszystkich statków możliwy jest reset planszy i ponowne rozstawienie. Kiedy obaj gracze rozstawią swoje statki rozpoczyna się gra. Gracze strzelają"<<endl<<"na zmianę wpisując współrzędne strzału. Jeżeli gracz trafił statek przeciwnika, strzela dalej, aż spudłuje. Gra toczy się do momentu aż któremuś z graczy nie zostanie już żaden niezatopiony"<<endl<<"statek. Wynik gry zapisywany jest do pliku wyniki.txt"<<endl<<"Wpisz dowolny znak aby kontynuować"<<endl;
                cin>>p;
                e=1;
                break;
            default:
